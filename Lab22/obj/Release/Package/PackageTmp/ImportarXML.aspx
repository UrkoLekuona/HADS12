<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ImportarXML.aspx.vb" Inherits="Lab22.ImportarXML" %>
...
<body>
    ...
    <div style="width: 1410px">
        ...
        <asp:Button ID="Button1" runat="server" Text="Importar (XMLD)" style="position:absolute; top: 299px; left: 36px; height: 51px; width: 160px;" />
        <asp:HyperLink ID="HyperLink1" style="position:absolute; top: 412px; left: 40px; width: 116px;" runat="server" NavigateUrl="~/Profesor.aspx">Menu Profesor</asp:HyperLink>
