<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Alumno.aspx.vb" Inherits="Lab22.MainAlumno" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" style="align-items: center; absolute; top: 20px; left: 7px; height: 385px; width: 284px;" BackColor="#FFFF99" BorderStyle="Outset">
            ...
            <asp:HyperLink ID="HyperLink3" runat="server" style="position: absolute; top: 71px; left: 82px;" NavigateUrl="~/TareasAlumno.aspx">Tareas Genéricas</asp:HyperLink>
        </asp:Panel>
