...
<body>
    ...
    <div style="width: 1410px">
        ...
        <asp:HyperLink ID="HyperLink1" style="position:absolute; top: 457px; left: 44px; width: 116px; height: 14px;" runat="server" NavigateUrl="~/Profesor/Profesor.aspx">Menu Profesor</asp:HyperLink>
